...
const MODULES = [
  ...
  },
  {
    id: 'loto',
    name: 'Lô tô',
    blurb: 'Rao số · Kinh hàng · vé giấy Tết',
    iconPath: '/modules/loto/icon.svg',
    coverPath: '/img/catalog/loto-cover.svg',
    entryPath: '/modules/loto/index.html',
    surfaceView: 'app_tienlen',
    kind: 'multiplayer',
    status: 'live',
    featured: true,
    maxSeats: 20,
    socketNamespace: '/loto',
    categoryLabel: '',
